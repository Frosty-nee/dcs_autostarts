...
-- CMDS & RWR
push_start_command(dt,		{message = _("ECM AND CMDS ENABLE"),									message_timeout = dt_mto})
push_start_command(dt,		{device = devices.RWR, 					action = rwr_commands.Power, 							value = 1.0})
push_start_command(dt, 		{device = devices.RWR, 					action = rwr_commands.Bit, 								value = 1.0})
...
push_start_command(dt,		{message = _("Enable IFF and DL"),									message_timeout = dt_mto})
...
push_start_command(dt+0.5,	{device = devices.UFC,					action = UFC_commands.FuncSwOnOff,						value = 1.0})
push_start_command(dt+0.5,	{device = devices.UFC,					action = UFC_commands.FuncSwOnOff,						value = 0.0})
push_start_command(dt,      {device = devices.UFC,					action = UFC_commands.FuncSwDL,							value = 1.0})
push_start_command(dt,      {device = devices.UFC,					action = UFC_commands.FuncSwDL,							value = 0.0})
push_start_command(dt+0.5,	{device = devices.UFC,					action = UFC_commands.FuncSwOnOff,						value = 1.0})
push_start_command(dt+0.5,	{device = devices.UFC,					action = UFC_commands.FuncSwOnOff,						value = 0.0})
-- turn on flir
push_start_command(dt,		{message = devices.TGP_INTERFACE, 		action = tgp_commands.Flir,								value = 1.0})
--
...
--
push_start_command(dt, 		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_18,					value = 1.0})
push_start_command(dt, 		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_17,					value = 1.0})
push_start_command(dt, 		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_19,					value = 1.0})
push_start_command(dt, 		{device = devices.AMPCD,				action = AMPCD_commands.AMPCD_PB_8,					    value = 1.0})
